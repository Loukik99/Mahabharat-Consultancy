...
const services = [
  ...
  s("epfo-services", "EPFO Services", "govt_docs", "EPFO claims, withdrawals, KYC updates, UAN activation, pension assistance and related services.", ["UAN / PF Number", "Aadhaar Card", "Bank Passbook", "Registered Mobile Number"], [{ label: "EPFO Official Website", url: "https://www.epfindia.gov.in/" }, { label: "EPFO Member Portal", url: "https://unifiedportal-mem.epfindia.gov.in/memberinterface/" }], { popular: true, processingTime: "Same day assistance" }),
  s("pf-esic", "PF & ESIC Assistance", "govt_docs", "Help with Provident Fund and ESIC registration, contributions, claims and related queries.", ["Aadhaar Card", "PAN Card", "Bank Details", "Employment / Establishment Details"], [{ label: "EPFO Official Website", url: "https://www.epfindia.gov.in/" }, { label: "ESIC Official Website", url: "https://www.esic.gov.in/" }]),
  ...
  s("gst-returns", "GST Filing", "tax_gst", "Monthly / quarterly GST return filing (GSTR-1, GSTR-3B and more).", ["GSTIN", "Sales & Purchase Data", "Previous Returns"], [{ label: "GST Portal", url: "https://www.gst.gov.in/" }]),
  ...
  s("eway-bill", "E-Way Bill", "tax_gst", "Generate and manage e-way bills for goods transport.", ["GSTIN", "Invoice Details", "Transport Details"], [{ label: "E-Way Bill Portal", url: "https://ewaybillgst.gov.in/" }]),
  ...
  s("tax-invoice-dc", "Tax Invoice / DC Preparation", "tax_gst", "Preparation of tax invoices and delivery challans (DC) for goods and services.", ["GSTIN", "Buyer / Consignee Details", "Item / Rate List", "HSN / SAC Codes"], []),
  s("billing-software", "Billing Software (Tally, Busy, etc.)", "tax_gst", "Setup and support for billing software such as Tally, Busy and similar tools.", ["Business Details", "GSTIN (if any)", "Item / Rate List"], []),
  s("pmegp", "PMEGP", "business", "Assistance with Prime Minister's Employment Generation Programme (PMEGP) applications for eligible individuals seeking to establish new micro-enterprises and self-employment ventures.", ["Aadhaar Card", "PAN Card", "Project / Business Details", "Bank Passbook", "Educational Qualification Proof (if required)"], [{ label: "PMEGP Official Portal", url: "https://pmegp.msme.gov.in/" }], { popular: true, processingTime: "Assistance on request" }),
  ...
  s("msme-udyam", "MSME (Udyam) Registration & Certificate", "business", "Udyam / MSME registration and certificate for micro, small and medium enterprises.", ["Aadhaar Card", "PAN Card", "Business Address Proof", "Bank Details"], [{ label: "Udyam Registration", url: "https://udyamregistration.gov.in/" }], { popular: true }),
  s("msme-trade-license", "MSME Trade License", "business", "Assistance with MSME-related trade licence applications and renewals.", ["Aadhaar Card", "PAN Card", "Udyam Certificate (if any)", "Business Address Proof"], []),
  s("fssai-license", "FSSAI License / Registration", "business", "FSSAI basic registration, state licence and central licence assistance for food businesses.", ["Aadhaar Card", "PAN Card", "Business Address Proof", "Food Business Details", "Photo"], [{ label: "FoSCoS (FSSAI)", url: "https://foscos.fssai.gov.in/" }]),
  s("gem-portal", "GeM Portal Registration & Bidding", "business", "Government e-Marketplace (GeM) seller / buyer registration and bidding support.", ["GSTIN Certificate", "PAN Card", "Cancelled Cheque", "Business Address Proof", "Aadhaar Card"], [{ label: "GeM Portal", url: "https://gem.gov.in/" }]),
  s("digital-signature", "Digital Signature (eMudra)", "business", "Digital Signature Certificate (DSC) application and eMudhra DSC support for filings and tenders.", ["Aadhaar Card", "PAN Card", "Passport Photo", "Email ID", "Mobile Number"], [{ label: "eMudhra", url: "https://www.emudhra.com/" }]),
